...
INSERT INTO "new_Campaign" ("created_at", "id", "mailbox_ids", "name", "qm_app_url", "qm_bounces", "qm_clicks", "qm_delivered", "qm_leads_total", "qm_opens", "qm_paused", "qm_replies", "qm_replies_pos", "qm_sent", "qm_unsubscribes", "quickmail_campaign_id", "status", "synced_at", "template_id", "updated_at") SELECT "created_at", "id", "mailbox_ids", "name", "qm_app_url", "qm_bounces", "qm_clicks", "qm_delivered", "qm_leads_total", "qm_opens", "qm_paused", "qm_replies", "qm_replies_pos", "qm_sent", "qm_unsubscribes", "quickmail_campaign_id", "status", "synced_at", "template_id", "updated_at" FROM "Campaign";
DROP TABLE "Campaign";
